...
public class MainActivity extends AppCompatActivity {
    ...
    public void numberchange(int[][] number_map,int huadong_state){
        int n = 0;
        int i = 0;
    ...
    public void random(int[][] number_map){
        int [] a = new int[2];
        ...
        for(int m = 0;m < 4;m++){
            for(int n = 0;n < 4;n++){
                ...
                if(number_map[m][n] != 0){
                    ...
                    Log.d("ddd", ""+ d);
                    tv[m*4+n].setBackgroundColor(background_color[d - 1]);
                }else {
                    tv[m*4+n].setText("");
                    tv[m*4+n].setBackgroundColor(0xeeeeeeee);
                }
